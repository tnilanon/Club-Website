...
public class UserBean implements Comparable< UserBean > {
	...
	private long membershipExpirationDateValue	= -1;
	...
	public long getMembershipExpirationDateValue()	{ return membershipExpirationDateValue;	}
	
	public void setUserName(String s)					{ userName = s;						}
	public void setEmailAddress(String s)				{ emailAddress = s;					}
	public void setHashedPassword(String s)				{ hashedPassword = s;				}
	public void setSalt(int i)							{ salt = i;							}
	public void setFirstName(String s)					{ firstName = s;					}
	public void setLastName(String s)					{ lastName = s;						}
	public void setSex(String s)						{ sex = s;							}
	public void setUserGroup(int i)						{ userGroup = i;					}
	public void setMembershipExpirationDateValue(long l){ membershipExpirationDateValue = l;}
